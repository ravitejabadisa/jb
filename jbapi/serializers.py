...
class BookSerializer(serializers.Serializer):
    ...
    def restore_object(self, attrs, instance=None):
        ...
        return Book(attrs.get('id'),attrs.get('name'),attrs.get('description'),attrs.get('published_date'),attrs.get('status'),attrs.get('author'),attrs.get('image'),attrs.get('users'),attrs.get('rent_price'),attrs.get('sell_price'))
...
class UserSerializer(serializers.Serializer):
    ...
    def restore_object(self, attrs, instance=None):
        ...
        return User(attrs.get('id'),attrs.get('first_name'),attrs.get('last_name'),attrs.get('email'),attrs.get('phone'),attrs.get('user_name'),attrs.get('home_longitude'),attrs.get('home_latitude'),attrs.get('office_longitude'),attrs.get('office_latitude'),attrs.get('rent_price'),attrs.get('sell_price'),attrs.get('books'))     
"""COMMENTED OUT
